...
class CountdownPicker: UIPickerView, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    var duration: TimeInterval {      //TimeInterval is pretty much Double
        // Convert from minute  + seconds to total seconds
